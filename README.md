...
**Hello React Frontend** is a frontend application to test the connection with my Rails backend.
...
<details>
  ...
  <ul>
    <li><a href="https://github.com/jmonto55/hello-rails-backend">Hello Rail Backend</a></li>
  </ul>
</details>
...
```
cd my-folder
git clone https://github.com/jmonto55/hello-react-frontend.git
```
